...
export function createApiBody(method = 'get', uri = '', data = {}, header = {}) {
	...
	const isSendData = method.toUpperCase() === 'PUT' || method.toUpperCase() === 'POST'
	const dataProperty = isSendData ? 'data' : 'params'
	res[dataProperty] = isSendData ? createFormDataBody(data) : data
	return res
}
